...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const apply=()=>{applyPuppyLogo();applyLoginMessage();addHeaderControls();addChangePassword();addPasswordRecovery();patchSameDayTradeSave()};apply();new MutationObserver(apply).observe(document.body,{childList:true,subtree:true});
});
